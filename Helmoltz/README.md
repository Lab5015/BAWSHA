# Helmoltz
This folder is dedicated to the numerical solution of the Helmoltz wave equation
...
## To do:
1. Scangeo to be reviewed (losses in particular)
2. Find a way to optimize grid search
3. Work on heatmap of confinment ratios